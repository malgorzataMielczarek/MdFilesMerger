...
namespace MdFilesMerger.Domain.Common
{
    ...
    public class MdFile : BaseDirectory, IDirectory
    {
        ...
        /// </summary>
        /// <remarks>
        /// If <paramref name="path"/> is a valid path to .md file, <see cref="BaseItem.Name"/> is set to path to this file, that uses <see langword="'/'"/> as directory separator character. Otherwise <see cref="BaseItem.Name"/> is set to <see langword="null"/>.
        /// </remarks>
        /// 
        /// <param name="path">
        ...
        /// 
        /// <param name="id">
        /// This item identification number.
        /// </param>
        /// <param name="path">
        /// Path to the .md file associated with this item. It can include extension or not.
        /// </param>
        ...
        /// </summary>
        /// <remarks>
        /// <inheritdoc/> If <paramref name="path"/> doesn't end with ".md" it adds this extension to <paramref name="path"/>.
        /// </remarks>
        /// 
        /// <param name="path">
        /// Valid absolute or relative path to the .md file, that you want to associate with this item.
        /// </param>
        /// 
        /// <returns>
        /// <inheritdoc/>
