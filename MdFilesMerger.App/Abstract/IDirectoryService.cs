...
namespace MdFilesMerger.App.Abstract
{
    ...
    ///          cref="Common.BaseDirectoryService{T}"/>, <see
    ///          cref="Common.RelativeFileService{T}"/>, <see cref="Concrete.IgnoredFileService"/>,
    ///          <see cref="Concrete.MainDirectoryService"/>, <see
    ///          cref="Concrete.MergedFileService"/>, <see cref="Concrete.SelectedFileService"/>
    ///     </para>
    /// </summary>
