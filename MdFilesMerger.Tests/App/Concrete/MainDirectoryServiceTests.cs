...
namespace MdFilesMerger.Tests.App.Concrete
{
    ...
    {
        [Fact]
        public void FindAllFiles_InvalidId_ReturnsEmpty()
        {
            // Arrange
        ...
        [Fact]
        public void FindAllFiles_Null_ReturnsEmpty()
        {
            // Arrange
            MainDirectoryService mainDirectoryService = new MainDirectoryService();
        ...
        [Fact]
        public void ReadByMergedFileId_UnsortedCollection_ReturnsSorted()
        {
            // Arrange
        ...
        [Fact]
        public void ReadByMergedFileId_ValidMergedFileId_ReturnsOnlyItemsWithGivenMergedFileId()
        {
            // Arrange
            List<IMainDirectory> mainDirectories = new List<IMainDirectory>();
